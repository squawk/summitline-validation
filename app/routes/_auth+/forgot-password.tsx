...
export async function action({ request }: Route.ActionArgs) {
	...
	const response = await sendEmail({
		to: user.email,
		subject: `Summit Line Validation Password Reset`,
		react: (
...
function ForgotPasswordEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Summit Line Validation Password Reset</E.Text>
				</h1>
				<p>
					<E.Text>
...
export const meta: Route.MetaFunction = () => {
	return [{ title: 'Password Recovery for Summit Line Validation' }]
}
