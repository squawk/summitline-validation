...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Summit Line Validation Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your Summit Line Validation email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your Summit Line Validation email has been
						changed.
					</E.Text>
				</p>
				<p>
